...
namespace DotneterWhj.WebApi
{
    ...
    public class SwaggerConfig
    {
        private static List<string> GetXmlCommentsPath()
        {
            ...
            xmlPaths.Add(String.Format(@"{0}bin\DotneterWhj.WebApi.xml", System.AppDomain.CurrentDomain.BaseDirectory));
            xmlPaths.Add(String.Format(@"{0}bin\DotneterWhj.DataTransferObject.xml", System.AppDomain.CurrentDomain.BaseDirectory));
